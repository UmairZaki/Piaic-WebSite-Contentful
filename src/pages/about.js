...
import TP from "../components/TP.module.scss"


const Piaic = ({ data }) => {
  
    const {title,h2,image,text} = data.contentfulAbout;
    // const drAlvi = {image.file.url};
    return (
    <Layout>
    <div className= {TP.body}>
    <div className= {TP.text}>
    <div className= {TP.img2}><img width= "386px" height= "auto" src={image["file"]["url"]}/></div>
<h1>{title}</h1>
<h2>{h2}</h2>
    {/* <h2>Pakistan</h2> */}
    <div className= {TP.logo}>
    <div className= {TP.img}><a href="https://www.facebook.com/Dr.ArifAlvi/" target = "_blank" ><img src={require("../components/15.png")} width="40" height="auto"  alt="klnaznc" /></a></div>
    <div ><a href="https://twitter.com/ArifAlvi" target = "_blank" ><img src={require("../components/13.png")} width="80" height="auto"  alt="klnaznc" /></a></div>
    </div>
<p>{text.text}</p>
