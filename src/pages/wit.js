...
export default () => <Layout>
  ...
  <div className={WIT.image6}></div>
  </div>
  
  <div className={WIT.spotlight}>
  <div className={WIT.image7}></div>
  ...
  <div className={WIT.image51}></div>
  </div>
  
  <div className={WIT.spotlight}>
  <div className={WIT.image52}></div>
  </div>
  
  <div className={WIT.spotlight}>
  <div className={WIT.image53}></div>
  ...
  <div className={WIT.image58}></div>
  <div className={WIT.image59}></div>
  </div>
