...
export default () => <Layout>
    ...
    <div className={HIT.h5}><h5>Classes Started</h5></div>
    </div>
    </div>
    ...
    <div className={HIT.h5}><h5>Accept applications in Sialkot</h5></div>
    </div>
    </div>
    ...
    <div className={HIT.h5}><h5>Coming Soon</h5></div>
    </div>
    </div>
	...
	<div className={HIT.circle_main2}></div>
    <div className={HIT.box}><h4>Pishawar</h4></div>
    <div className={HIT.h5}><h5>Coming Soon</h5></div>
    </div>
    </div>
